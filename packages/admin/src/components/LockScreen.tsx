                ...
                <div className="grid grid-cols-3 gap-x-6 gap-y-3">
                  {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
                    <button
                      ...
                      disabled={loading}
                      className="w-[75px] h-[75px] rounded-full bg-gray-100 hover:bg-gray-200 active:bg-gray-300 flex items-center justify-center transition-all duration-100 disabled:opacity-50 select-none"
                    >
                      <span className="text-[28px] font-light text-gray-800 leading-none">{num}</span>
                    </button>
                  ))}
                  {/* Forgot PIN */}
                  <button
                    ...
                    className="w-[75px] h-[75px] rounded-full flex items-center justify-center select-none"
                  >
                  ...
                  <button
                    ...
                    className="w-[75px] h-[75px] rounded-full bg-gray-100 hover:bg-gray-200 active:bg-gray-300 flex items-center justify-center transition-all duration-100 disabled:opacity-50 select-none"
                  >
                    <span className="text-[28px] font-light text-gray-800 leading-none">0</span>
                  </button>
                  {/* Delete */}
                  <button
                    type="button"
                    ...
                    className="w-[75px] h-[75px] rounded-full flex items-center justify-center select-none disabled:opacity-30"
                  >
