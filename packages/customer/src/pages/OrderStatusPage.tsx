...
export default function OrderStatusPage() {
  ...
  useEffect(() => {
    const unsubscribe = onOrderStatusUpdate((update) => {
      if (update.orderId === orderId) refetch();
    });
    return unsubscribe;
  }, [orderId, onOrderStatusUpdate, refetch]);
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              <div className="p-6 text-center">
                ...
                <h1 className="text-xl font-bold text-gray-900 mb-1">
                  {isCompleted ? 'Order Complete!' : isCancelled ? 'Order Cancelled' : 'Order In Progress'}
                </h1>
                ...
                {order.estimatedReadyTime && !isCompleted && !isCancelled && (
                  <div className="mt-3 inline-flex items-center gap-1.5 bg-blue-50 text-blue-600 text-sm font-medium px-3 py-1.5 rounded-full">
                    ...
                    Ready by {fmtTime(order.estimatedReadyTime)}
                  </div>
                )}
              </div>
            </motion.div>
            ...
            <div className="mt-3 mx-4 lg:mx-0 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="px-4 py-3.5 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900">Ordered at</p>
            ...
            {order.specialInstructions && (
              <div className="mt-3 mx-4 lg:mx-0 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="px-4 py-3.5 flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Special Instructions</p>
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-6">
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    This action cannot be undone. Your order will be cancelled and you will need to place a new one.
                  </p>
            ...
            <div className="sticky top-[80px] space-y-4">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div className="text-center mb-4">
                  ...
                  <h2 className="font-bold text-gray-900">
                    {isCompleted ? 'Order Complete!' : isCancelled ? 'Order Cancelled' : 'In Progress'}
                  </h2>
              ...
              {order.estimatedReadyTime && !isCompleted && !isCancelled && (
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-4 py-3.5 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Estimated Ready</p>
